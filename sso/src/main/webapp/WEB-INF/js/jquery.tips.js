...
(function ($) {
    ...
    if(!$('#jquery_tips_style').length){
        ...
        style+='.jq_tips_info{word-wrap: break-word;word-break:normal;border-radius:4px;padding:5px 8px;max-width:130px;overflow:hidden;font-size:12px;cursor:pointer;}';
        style+='</style>';
