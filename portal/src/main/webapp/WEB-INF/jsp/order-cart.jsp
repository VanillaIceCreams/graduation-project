...
<form id="orderForm" class="hide" action="/order/create.html"  method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="章夏杰"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="13588274780"/>
		<input type="hidden" name="orderShipping.receiverState" value="杭州"/>
		...
		<input type="hidden" name="orderShipping.receiverAddress" value="浙江科技学院"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">章夏杰</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">135****4781</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">杭州市西湖区</div>
						<div class="adr-m" limit="30">浙江科技学院 西和公寓</div>
    ...
    <div class="ui-ceilinglamp checkout-buttons">
      ...
      <div class="sticky-wrap">
          ...
          <div style="display:none" id="factoryShipCodShowDivBottom" class="dispatching">
            部分商品货到付款方式：先由配送“提货单”并收款，然后厂商发货。
          </div>
        </div>
